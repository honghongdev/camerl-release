...
class Decoder(nn.Module):
    ...
    def __init__(self, img_channels, latent_size):
        ...
        self.fc1 = nn.Linear(latent_size, 2*2*256)
        ...
        self.deconv6 = nn.ConvTranspose2d(8, img_channels, 4, stride=2)
...
class Encoder(nn.Module): # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, img_channels, latent_size):
        ...
        self.conv1 = nn.Conv2d(img_channels, 8, 4, stride=2)
        self.conv2 = nn.Conv2d(8, 16, 4, stride=2)
        self.conv3 = nn.Conv2d(16, 32, 4, stride=2)
        self.conv4 = nn.Conv2d(32, 64, 4, stride=2)
        self.conv5 = nn.Conv2d(64, 128, 4, stride=2)
        self.conv6 = nn.Conv2d(128, 256, 4, stride=2)
